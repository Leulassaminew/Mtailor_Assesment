...
url = "https://api.cortex.cerebrium.ai/v4/p-bf38fce8/mtailor/run"
headers = {
...
with open("images/n01440764_tench.jpeg", "rb") as f:
    response = requests.post(f"{url}/predict",  headers=headers, files={"file": f})
